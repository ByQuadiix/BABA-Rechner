...
void main() {
    ...
    ActionListener BTNlistener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            JPanel newPanel = Builder.BuildPanel(Rechenlogik.getEinheiten(text), () -> update(menuPanel));
            if (newPanel == null) {
    ...
    JButton TemperaturBtn = new JButton();
    TemperaturBtn.setName("Temperatur");
    TemperaturBtn.setHorizontalAlignment(SwingConstants.CENTER);
    TemperaturBtn.setIcon(new ImageIcon("Assets/icon/temperature.png"));
    TemperaturBtn.addActionListener(BTNlistener);
